    ...
    render() {
        ...
        return (
            <div key={this.key} 
                ...
                <span className='col-12 p-0 py-2 pl-3'>{this.getTitle()}</span>
                <ul id={this.key} 
                    className='position-absolute border border-top-0 rounded-bottom d-none col-12 col-xm-10 col-sm-8 col-md-6 col-lg-4 col-xl-2 m-0 p-2'
