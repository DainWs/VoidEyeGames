...
import MediaTab from '../utils/MediaTab';
      ...
      <article className='m-lg-3'>
        ...
        <section className='row p-0 m-0 m-sm-1'>
          <div className='row col-12 col-lg-4 w-100 h-50 h-lg-100 overflow-hidden p-0 m-2 m-lg-0'>
            <div className='col-4 col-lg-12 h-100 h-lg-50 p-0 overflow-hidden'>
                {this.getGameImageView() || <Skeleton style={{height: '100%'}}/>}
            </div>
            <div className='col-8 col-lg-12 h-100 h-lg-50 p-0 d-flex flex-column justify-content-center'>
        ...
        <section className='p-3 p-lg-0'>
          ...
          <div className='d-flex flex-column justify-content-center'>
            <div className='row m-3'>
                <div className='col-8 col-sm-10'><hr/></div>
                <a className='col-4 col-sm-2 btn btn-quaternary align-self-baseline' onClick={this.doComment.bind(this)}>Comment</a>
            </div>
            <div>
  ...
  preparePlataformView(plataformGame) {
    ...
    return (
      <div key={`${plataformGame.gamesId}-${plataformGame.plataformsId}__price-tag`} 
        className='row border border-black m-0 mt-2 p-2'
        style={{marginTop: '1rem', maxWidth: '100%', overflow: 'hidden'}}>
        
        <div className='col-1 border border-black p-0'>
